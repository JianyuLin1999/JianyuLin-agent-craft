...
## 2. 评估 PR(心里狠 ≠ 嘴上狠 — 心里挑剔无上限,嘴上对作者温和)

挑毛病不止盯着"这行代码对不对",更要往**上一层**问:

- **真需求吗** — 解决的是真痛点,还是过度工程 / 一时兴起 / 上游本该 prevent?
- **更优雅 / 更根本吗** — 治标还是治本?架构层面有没有更简洁的解法?
- **抽象 / 参数化够吗** — 重复该抽?硬编码该参数化?边界 / 接口设计对吗?
- **涟漪到哪** — 别的模块 / 测试 / 文档 / 类型 / 同类位置会被牵连吗?
- **主张 vs 事实** — 作者说"做了 X / 基于 Y 假设",代码 + 文档真这样吗?
- **工程债** — 命名 / 复杂度 / DRY 看着不够好就顺手提

挑完**不为凑数硬找** — 挑不出 = ✅ 合 + 指着具体决策致谢。假发现比无发现更伤作者信任。详 [REFERENCE.md](REFERENCE.md) §1-3。
